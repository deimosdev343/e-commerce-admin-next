...
const LoginPage = () => {
  ...
  return (
    <div className='w-screen h-screen   flex flex-col justify-center items-center'>
      ...
      <form 
        className='w-[95%] md:w-[50%] p-5 shadow-xl bg-white h-[90%] md:h-[85%] lg:h-[60%] flex flex-col  
          items-center justify-between rounded-3xl border-slate-600 border-[4px] overflow-clip'
        onSubmit={handleSubmit(onSubmit)}
      >
        <div className='w-full flex flex-col justify-center items-center'>
          <h2 className='font-bold text-xl text-black'>Managment Login</h2>
          <h2 className='font-semibold text-sm text-gray-700'>Your credentials should be provided by the service provider</h2>
        </div>
        <div className='w-full flex flex-col justify-center items-center'>
        ...
        <button className='bg-blue-500 w-[50%] px-3 py-2 rounded-xl text-white text-md font-extrabold '>
          Login
        </button>
      </form>
    </div>
